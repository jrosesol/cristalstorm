...
public class SendMceToServerHandler implements
    ...
    public SendMceToServerResult execute(SendMceToServer action,
        ...
        Mce mce = new Mce(action.getMceToServer().uri,
                action.getMceToServer().tags);
        ofy.put(mce);
        assert mce.id != null; // id was autogenerated

        // Get it back
        Mce mceFetched = ofy.get(new Key<Mce>(Mce.class, mce.id));
...
//        }
        ...
        // Delete it
        // ofy.delete(porsche);
        //TODO: persistence is happening here : return proper Mce on success

        return new SendMceToServerResult(new MceDto(mceFetched.uri, mceFetched.tags));
    }
